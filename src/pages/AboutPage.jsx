...
function AboutPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Sobre Nosotros | Pet Fashion</title>
        <meta name="description" content="Conoce al equipo de Pet Fashion. Somos estilistas caninos comprometidos con el bienestar y la estética de tu mascota." />
        <link rel="canonical" href="https://www.petfashiondogsalon.cl/sobre-nosotros" />
      </Helmet>
