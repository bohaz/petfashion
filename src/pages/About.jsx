...
function About() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="font-bold mb-5 md:mb-10 text-4xl md:text-5xl xl:text-6xl text-center text-neutral-700">Quiénes Somos</h1>
        <div className="flex flex-col items-center md:flex-row">
          <img className="w-52" src={MedallaHuella} alt="Huella" />
          <p className="bg-amber-200 p-4 md:text-lg rounded-lg shadow-lg shadow-neutral-400 text-center max-w-lg">
