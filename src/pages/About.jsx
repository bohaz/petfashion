...
function About() {
  ...
  return (
    ...
    >
      ...
      <h1 className="font-bold md:mb-5 text-4xl md:text-5xl xl:text-6xl text-center text-gray-800 relative after:content-[''] after:block after:w-40 after:h-1 after:bg-pink-400 after:mt-2 after:mx-auto">Quiénes Somos</h1>
