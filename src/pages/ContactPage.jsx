...
function Contact() {
  return (
    <>
      <Helmet>
        <title>Contáctanos | Pet Fashion</title>
        <meta
          name="description"
          content="¿Tienes preguntas o deseas reservar una cita? Contáctanos en Pet Fashion y estaremos encantados de ayudarte con el cuidado de tu mascota."
        />
        <link rel="canonical" href="https://www.petfashiondogsalon.cl/contacto" />
      </Helmet>
