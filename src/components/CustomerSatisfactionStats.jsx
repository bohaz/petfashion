...
const CustomerSatisfactionStats = () => (
  <section className="bg-cream text-white px-2 py-14 lg:px-28 lg:py-28">
    <div className="container mx-auto text-center">
      <h2 className="text-3xl md:text-5xl font-bold text-grayDarker mb-6 lg:mb-14">
        Estatus de
        {' '}
        <span className="font-shadows text-teal-600">clientes</span>
        {' '}
        Satisfechos
      </h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="p-4 border border-grayLight rounded-lg shadow-md flex gap-3 items-center justify-center">
          <div className="bg-softOrange p-2 rounded-md">
            <img src={clientIcon} alt="Clientes Atendidos" className="w-9 h-9" />
          </div>
          <div className="text-left text-grayDark">
