  ...
  return (
    ...
    >
      <h1 className="font-bold mb-5 md:mb-10 text-4xl md:text-5xl xl:text-6xl text-center text-grayDarker">
        Antes de
        {' '}
        <span className="font-shadows text-tealDark">Agendar</span>
      </h1>
      <div className="p-4 pb-10 pt-10 flex flex-col gap-5 items-center bg-contain bg-center bg-white md:flex-row">
        ...
        >
          <div className="bg-white rounded-xl p-4 border-2 border-grayDarker shadow-xl flex flex-col items-center">
            <img className="w-20 m-auto mt-1" src={One} alt="icono" />
            <p className="text-grayDarker md:text-lg">
      ...
      <motion.div
        ...
        className="relative z-10"
      >
        <h2 className="font-bold mt-10 md:mb-10 text-4xl md:text-5xl xl:text-6xl text-center text-grayDarker">
          Cómo
          {' '}
          <span className="font-shadows text-tealDark">Agendar?</span>
        </h2>
        <div className="flex flex-col md:flex-row items-center justify-center mt-10 space-y-4 md:space-y-0 md:space-x-4">
          <div className="relative">
            ...
            <p className="text-grayDarker mt-2 text-center font-bold md:text-lg">Escríbenos Por Whatsapp</p>
          </div>
          ...
          <div className="relative">
            ...
            <p className="text-grayDarker mt-2 text-center font-bold md:text-lg">Te haremos algunas preguntas</p>
          </div>
          <div className="h-0.5 w-10 bg-gray-400 md:w-0.5 md:h-10" />
          <div className="relative">
            <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold m-auto">
            ...
            <p className="text-grayDarker mt-2 text-center font-bold md:text-lg">Agendamos tu cita</p>
          </div>
          <div className="h-0.5 w-10 bg-gray-400 md:w-0.5 md:h-10" />
          <div className="relative">
            <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold m-auto">
            ...
            <p className="text-grayDarker mt-2 text-center font-bold md:text-lg">Y ya está, es así de fácil.</p>
          </div>
        </div>
